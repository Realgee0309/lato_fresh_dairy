...
// Count users by role
$role_stats = $db->query("SELECT role, COUNT(*) as count FROM users WHERE active = 1 GROUP BY role");
$total_users = $db->query("SELECT COUNT(*) as count FROM users")->fetch_assoc()['count'];
$active_users = $db->query("SELECT COUNT(*) as count FROM users WHERE active = 1")->fetch_assoc()['count'];
...
<head>
    ...
    <style>
        ...
        .user-list-item.active .user-list-avatar {
            border-color: #667eea;
        }
...
<body>
    <div class="admin-container">
        ...
        <div class="users-sidebar">
            <div class="users-sidebar-header">
                ...
                <p class="sidebar-subtitle">Manage all system users</p>
                ...
                <div class="filter-tabs">
                    ...
                    <button class="filter-tab" onclick="filterByStatus('active')">Active</button>
                    <button class="filter-tab" onclick="filterByStatus('inactive')">Inactive</button>
                </div>
                
                <a href="index.php" class="btn btn-secondary btn-small" style="margin-top: 15px; width: 100%; text-align: center; display: block;">
            ...
            <div id="usersList">
                <?php while ($user = $all_users->fetch_assoc()): 
                    $user_avatar = 'https://ui-avatars.com/api/?name=' . urlencode($user['full_name']) . '&size=45&background=667eea&color=fff&bold=true';
                    if (!empty($user['profile_image']) && file_exists($user['profile_image'])) {
                        $user_avatar = $user['profile_image'];
                    }
                    $is_active = ($user['id'] == $edit_user_id) ? 'active' : '';
                    $status_class = $user['active'] ? 'active' : 'inactive';
                ?>
        ...
        <div class="user-content">
            ...
            <div class="stats-overview">
                <div class="stat-card-mini">
                    ...
                    <div class="stat-info-mini">
                        <div class="stat-value-mini"><?php echo $total_users; ?></div>
                ...
                <div class="stat-card-mini">
                    ...
                    <div class="stat-info-mini">
                        <div class="stat-value-mini"><?php echo $active_users; ?></div>
                        <div class="stat-label-mini">Active Users</div>
                    </div>
                </div>
                
                <div class="stat-card-mini">
                    <div class="stat-icon-mini red">
                        <i class="fas fa-user-slash"></i>
                    </div>
                    <div class="stat-info-mini">
                        <div class="stat-value-mini"><?php echo $inactive_users; ?></div>
                        <div class="stat-label-mini">Inactive Users</div>
                    </div>
                </div>
            </div>
            ...
            <div class="profile-header-admin">
                <div class="profile-image-container">
                    ...
                    <form method="POST" enctype="multipart/form-data" id="imageForm" style="display: inline;">
                        ...
                        <label for="imageInput" class="profile-image-upload" title="Change profile picture">
                            <i class="fas fa-camera" style="color: #667eea; font-size: 18px;"></i>
                        </label>
                ...
                <div class="profile-info" style="flex: 1;">
                    ...
                    <p style="font-size: 16px; opacity: 0.95; margin-bottom: 5px;">
                        <i class="fas fa-at"></i> <?php echo htmlspecialchars($user_data['username']); ?>
                    </p>
                    ...
                    <div class="profile-badges">
                        <span class="profile-badge">
                            ...
                            <?php echo get_role_display($user_data['role']); ?>
                        </span>
                        <span class="profile-badge" style="background: <?php echo $user_data['active'] ? 'rgba(102,187,106,0.3)' : 'rgba(239,83,80,0.3)'; ?>">
                            <i class="fas fa-circle" style="font-size: 8px;"></i> 
                            <?php echo $user_data['active'] ? 'Active' : 'Inactive'; ?>
                        </span>
                        <span class="profile-badge">
                            <i class="fas fa-calendar"></i>
                            Joined <?php echo date('M Y', strtotime($user_data['created_at'])); ?>
                        </span>
                    </div>
            ...
            <div class="danger-zone">
                ...
                <p style="color: #721c24; margin-bottom: 20px; line-height: 1.6;">
    ...
    <script>
        ...
        function deleteUser(userId) {
            if (confirm('⚠️ Are you absolutely sure you want to delete this user?\n\nThis action CANNOT be undone!\n\nAll user data will be permanently lost.')) {
